...
class OpenCodeAgentRunner:
    """Manages an OpenCode ACP session for the daria daemon."""
    ...
    async def start(self, initial_prompt: str = "") -> None:
        ...
        self._isolated_home = tempfile.mkdtemp(prefix="daria-opencode-")
        ...
        try:
            ...
            resp = await self._send_request("initialize", {
                ...
                "clientInfo": {"name": "daria-opencode", "version": "0.1.0"},
            })
