...
from daria.daemon.config import DaemonConfig, AgentConfig
from daria.daemon.ipc import make_response
from daria.daemon.irc_transport import IRCTransport
from daria.daemon.message_buffer import MessageBuffer
from daria.daemon.socket_server import SocketServer
from daria.daemon.webhook import WebhookClient, AlertEvent
...
class OpenCodeDaemon:
    ...
    def _build_system_prompt(self) -> str:
        return (
            f"You are {self.agent.nick}, an AI agent on the DaRIA IRC network.\n"
